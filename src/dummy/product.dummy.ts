...
`https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/veg.jpg?alt=media&token=cc24e732-b95c-48d2-b2f1-88fdc4c3c335`
    ...
    subCategories: [ '전체보기','친환경', '고구마·감자·당근', '시금치·부추·나물', '브로콜리·파프리카·양배추','양파·대파·마늘·배추','오이·호박·고추','냉동·이색·간편채소','콩나물·버섯']
  },
  {
    name:'과일·견과·쌀',
    products:[
...
`https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/veg.jpg?alt=media&token=cc24e732-b95c-48d2-b2f1-88fdc4c3c335`
  ...
  },
  {
    ...
    subCategories:[
      '전체보기','제철수산','생선류','굴비·반건류','연어·참치','회·탕류','오징어·낙지·문어','해산물·전복·조개류','새우·게·랍스터','수산가공품','명란','젓갈·장류','간편구이',
      '김·미역·해조류','멸치·황태·해조류','멸치·황태·다시팩','조미오징어·어포·쥐포'
    ]
  },
  { 
    name: '국·반찬·메인요리',
...
//   },
  ...
  //     `https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/salad-7844746_640.jpg?alt=media&token=20750c19-efb6-46e3-8eaa-cb6a7b3c79fb`,
  //     `https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/salad-818584_640.jpg?alt=media&token=0aadc9ff-c264-48c4-ad69-2ed2c68c7c7e`,
  //     `https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/sandwich-2301387_640.jpg?alt=media&token=fa2e1fc6-b432-44b5-bd03-ac5b19a3f536`,
  //     `https://firebasestorage.googleapis.com/v0/b/kurly-75ac0.firebasestorage.app/o/strawberry-dessert-2191973_640%20(1).jpg?alt=media&token=1890a5ff-a401-4d09-a353-69f039f0481a`
  //   ]
  // },
  // {
  //   name: '면·양념·오일',
...
export const generateProducts = (count: number) => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const subCategory=faker.helpers.arrayElement(product.subCategories)
