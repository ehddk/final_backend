...
class AdminShipStatusController {
    _adminShipService;
    ...
    /** 함선 상태 조회 (관리자) */
    async getAdminShipStatus(req, res, next) {
        try {
    ...
    /** 함선 상태 생성 (관리자) */
    async createAdminShipStatus(req, res, next) {
        try {
            const shipStatus = await this._adminShipService.createShipStatus(req.body);
            res.send(shipStatus);
        }
        catch (error) {
            next(error);
    ...
    /** 함선 상태 수정 (관리자) */
    async updateAdminShipStatus(req, res, next) {
        try {
            const { statusId } = req.params;
    ...
    /** 함선 상태 삭제 (관리자) */
    async deleteAdminShipStatus(req, res, next) {
        try {
            const { statusId } = req.params;
...
exports.default = AdminShipStatusController;
//# sourceMappingURL=adminShipStatus.controller.js.map