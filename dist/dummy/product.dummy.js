...
exports.generateProducts = exports.PACKAGE_TYPES = exports.DELIVERY_TYPES = exports.CATEGORIES = void 0;
...
//  ];
exports.DELIVERY_TYPES = ['무료배송', '유료배송'];
exports.PACKAGE_TYPES = ['상온', '냉장', '냉동'];
const generateProducts = (count) => {
    const products = [];
    for (let i = 0; i < count; i++) {
        //배열에서 무작위로 값을 선택하기 위한 함수 arrayElement !!
        const category = faker_1.fakerKO.helpers.arrayElement(PRODUCT_CATEGORIES);
        const name = faker_1.fakerKO.helpers.arrayElement(category.products);
        const description = faker_1.fakerKO.helpers.arrayElement(DESCRIPTIONS);
        const img = faker_1.fakerKO.helpers.arrayElement(category.images);
        const price = faker_1.fakerKO.number.int({ min: 1000, max: 100000 });
        ...
        products.push({
            ...
            thumbnail: img,
            img: img,
            delivery: faker_1.fakerKO.helpers.arrayElement(exports.DELIVERY_TYPES),
            seller: faker_1.fakerKO.company.name(),
            description: `${description}`,
            packageType: faker_1.fakerKO.helpers.arrayElement(exports.PACKAGE_TYPES),
            //detail: faker.lorem.paragraph(),
            category: faker_1.fakerKO.helpers.arrayElement(exports.CATEGORIES)
        });
    }
    return products;
};
exports.generateProducts = generateProducts;
//# sourceMappingURL=product.dummy.js.map